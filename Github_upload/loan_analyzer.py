...
annual_discount = 0.2
present_value = future_value / (1 + annual_discount/12) ** remaining_months
...
if present_value >= loan_price: 
    ...
    print("The loan is too expensuve and not worth the price")
...
print (f"The inexpensive_loans are: {inexpensive_loans}")
